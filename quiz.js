...
let questions = [
  {
    numb: 1,
    question:
      "Apakah inti utama dari Matahari yang memancarkan energi besar melalui reaksi termonuklir?",
    answer: "Inti",
    options: ["Fotosfer", "Korona", "Zona Konvektif", "Inti"],
  },
  {
    numb: 2,
    question: "Berapakah jarak rata-rata Bumi dari Matahari?",
    answer: "150 juta km",
    options: ["100 juta km", "150 juta km", "200 juta km", "250 juta km"],
  },
  {
    numb: 3,
    question: "Planet mana yang dikenal memiliki variasi suhu harian terbesar?",
    answer: "Merkurius",
    options: ["Merkurius", "Bumi", "Venus", "Mars"],
  },
  {
    numb: 4,
    question: "Apa yang menyebabkan warna biru pada Uranus?",
    answer: "Metana",
    options: ["Hidrogen", "Helium", "Metana", "Nitrogen"],
  },
  {
    numb: 5,
    question:
      "Fenomena apakah yang terjadi saat Merkurius melintas di depan piringan Matahari?",
    answer: "Transit",
    options: ["Transit", "Gerhana", "Konjungsi", "Oposisi"],
  },
  ...
  },
  {
    numb: 7,
    question:
      "Apakah nama kawah besar di Merkurius yang memiliki sinar terang memancar hingga 1000 km?",
    answer: "Kawah Hokusai",
    options: ["Kawah Caloris", "Kawah Hokusai", "Kawah Gusev", "Kawah Gale"],
  },
  {
    numb: 8,
    question:
      "Apakah lapisan atmosfer Bumi yang melindungi dari radiasi berbahaya?",
    answer: "Stratosfer",
  ...
  },
  {
    numb: 10,
    question:
      "Planet manakah yang memiliki cincin yang paling terkenal dan kompleks?",
    answer: "Saturnus",
  ...
  },
  {
    numb: 11,
    question:
      "Medan magnet Matahari yang sangat kuat dapat mempengaruhi cuaca antariksa. Bagaimanakah fenomena ini dapat berdampak pada bumi dan satelit yang mengorbit di sekitarnya?",
  ...
  },
  {
    numb: 12,
    question:
      "Apa yang menyebabkan efek rumah kaca yang tak terkendali di Venus?",
  ...
  },
  {
    ...
    answer: "687 hari",
    options: ["225 hari", "365 hari", "687 hari", "880 hari"],
  },
  {
    numb: 14,
    question:
      "Apakah nama badai besar yang sudah berlangsung selama lebih dari 300 tahun di Jupiter?",
  ...
  },
  {
    numb: 15,
    question:
      "Medan magnet Uranus yang tidak simetris dan tidak terpusat pada inti planet disebabkan oleh?",
  ...
  },
  {
    ...
    answer: "11 tahun",
    options: ["5 tahun", "7 tahun", "11 tahun", "15 tahun"],
  },
  {
    numb: 17,
    question:
      "Apakah yang ditemukan oleh misi MESSENGER NASA di kutub gelap Merkurius?",
    answer: "Es air",
    options: ["Es air", "Lava beku", "Gas metana", " Kawah baru"],
  },
  {
    numb: 18,
    question:
      "Apakah unsur utama yang membentuk atmosfer Titan, bulan terbesar Saturnus?",
    answer: "Nitrogen",
  ...
  },
  {
    numb: 20,
    question:
      "Apakah fenomena yang menyebabkan metana ditemukan di atmosfer Mars?",
